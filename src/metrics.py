...
if __name__ == "__main__":
    t = [1.5, 2.5, 0.5, 0.8]
    p = [1.2, 2.0, 0.7, 0.9]
    print(RegressionMetrics()("mse", t, p))
    print(RegressionMetrics()("rmse", t, p))
    print(RegressionMetrics()("rmsle", t, p))
    print(RegressionMetrics()("r2", t, p))
    print(RegressionMetrics()("mae", t, p))
